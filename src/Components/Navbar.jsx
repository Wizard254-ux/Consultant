...
function Navbar({displaySideBar, isSideBar}) {
    ...
    return (
        <>
            ...
            <nav className="flex flex-row justify-between gap-3 min-h-14 md:min-h-12  items-center px-5 bg-slate-100 sticky top-0 z-[4000] shadow-lg">
                <div className="rounded-full justify-center flex  flex-row gap-2 items-center ">
                    <img 
                        className="w-[50px] h-[50px] scale-110 rounded-md bg-transparent my-0  md:my-4" 
                        src="logo.png"
                    ...
                    />
                    <h1 className="text-md md:text-xl font-bold tracking-wide font-serif">ERISPE IT SOLUTIONS & CONSULTANCY</h1>
                </div> 
                ...
                <ul className={`
                    ...
                    md:translate-x-0
                `}>
                    <div className="md:hidden justify-center items-center mt-4 ml-2">
                    
                    <h1 className="text-md font-bold tracking-wide font-serif">ERISPE IT SOLUTIONS & CONSULTANCY</h1>
                </div> 
                    <li>
                        <span 
                            onClick={() => goTo('/')} 
